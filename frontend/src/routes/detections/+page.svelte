		...
		<div class="detection-masonry">
			{#each allDetections as detection (detection.File_Name)}
				<div class="detection-masonry-item space-y-2 min-w-0">
					...
					/>
					<div class="grid grid-cols-2 gap-2 rounded-lg border border-gray-200/80 bg-white px-3 py-2 text-sm shadow-sm sm:flex sm:flex-wrap sm:items-center dark:border-dark-border/80 dark:bg-dark-card">
						<a class="btn-primary btn-sm w-full sm:w-auto" href={detectionRecordingsHref(detection)}>
							Open in Library
						</a>
						<button
							type="button"
						...
						<button
							type="button"
							class="inline-flex w-full items-center justify-center rounded-lg px-3 py-1.5 text-sm font-medium text-amber-700 transition-colors hover:bg-amber-50 sm:w-auto dark:text-amber-300 dark:hover:bg-amber-900/20"
						...
						<button
							type="button"
							class="inline-flex w-full items-center justify-center rounded-lg px-3 py-1.5 text-sm font-medium text-red-600 transition-colors hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto dark:text-red-300 dark:hover:bg-red-900/20"
